...
const HistoryItem = ({ item, navigation, isCancel, setIsCancel }) => {
  ...
  const formatTime = (timeString) => {
    ...
    const formattedTime =
      vietnamTime.getUTCHours().toString().padStart(2, '0') + ':' +
      vietnamTime.getUTCMinutes().toString().padStart(2, '0') + ':' +
      vietnamTime.getUTCSeconds().toString().padStart(2, '0');

    const formattedDate =
      vietnamTime.getUTCDate().toString().padStart(2, '0') + '/' +
      (vietnamTime.getUTCMonth() + 1).toString().padStart(2, '0') + '/' +
